...
def main():
    '''
    scrapes basketball-reference for all the shooting stats for active players
    '''
    ...
    for l in letters:
        ...
        for p in tbodyLetterSoup.findAll("strong"):
            ...
            startTable = playerSoupStr.find("<tr id=\"shooting.")
    ...
    with open("csvs/shooting.csv", mode='w') as player_per_game:
