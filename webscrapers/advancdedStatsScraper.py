...
def main():
    '''
    scrapes basketball-reference for all the advanced stats for active players
    '''
    ...
    for l in letters:
        ...
        for p in tbodyLetterSoup.findAll("strong"):
            ...
            startTable = playerSoupStr.find("<tr id=\"advanced.")
    ...
    with open("csvs/advanced_stats.csv", mode='w') as player_per_game:
