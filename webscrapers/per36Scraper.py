...
def main():
    '''
    scrapes basketball-reference for all the per36 stats for active players
    '''
    ...
    for l in letters:
        ...
        for p in tbodyLetterSoup.findAll("strong"):
            ...
            startTable = playerSoupStr.find("<tr id=\"per_minute.")
    ...
    with open("csvs/per_36.csv", mode='w') as player_per_game:
