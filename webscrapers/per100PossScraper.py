...
def main():
    '''
    scrapes basketball-reference for all the per100 possessions stats for active players
    '''
    ...
    for l in letters:
        ...
        for p in tbodyLetterSoup.findAll("strong"):
            ...
            startTable = playerSoupStr.find("<tr id=\"per_poss.")
    ...
    with open("csvs/per_100_poss.csv", mode='w') as player_per_game:
